...
def get_product_links(url):
    ...
    try:
        ...
        elem = driver.find_element(by=By.CLASS_NAME, value='results-base')
...
def main():
    page_links=['https://www.myntra.com/womens-shoes?p='+str(i)+'&rows=100' for i in range(1,page_upto+1)]
